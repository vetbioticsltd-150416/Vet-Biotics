                  ...
                  return Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('Tự động chuyển đổi theo cài đặt hệ thống'),
                      ...
                      ListTile(
                        ...
                        title: const Text('Hiệu ứng động'),
                        subtitle: const Text('Bật/tắt các hiệu ứng chuyển động'),
                        trailing: Switch(
                          value: themeProvider.animationsEnabled,
                          onChanged: (value) async {
                            await themeProvider.setAnimationsEnabled(value);
                          },
                        ),
                      ),
                    ],
